...
import { Button, Table, Modal, Tooltip, Divider, Menu, List, Card, Image } from 'antd';
...
export default connect(mapStateToProps, mapDispatchToProps, null, { forwardRef: true })(VideoList);
